...
class HistoryManager:
    ...
    def delete_by_type(self, activity_type: str | None = None) -> int:
        """Delete all entries of a specific type, or all if type is None."""
        history = self._load_history()
        original_length = len(history)
        ...
        if activity_type is None:
            ...
            # Delete entries of specific type
            history = [h for h in history if h["type"] != activity_type]
