...
Unified embedding client for all Syncora services.
...
class EmbeddingClient:
    ...
    def get_embedding_func(self):
        """
        Get an EmbeddingFunc-compatible object for document embedding.
        ...
        # Create a simple EmbeddingFunc-like object
        # (Compatible with local RAG systems that don't require lightrag)
        class EmbeddingFunc:
