...
Unified LLM client for all Syncora services.
"""
...
class LLMClient:
    ...
    async def complete(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            # Fallback if lightrag not available - use cloud_provider directly
    ...
    def get_model_func(self):
        ...
        try:
            ...
            # Fallback if lightrag not available
            from . import cloud_provider
            import asyncio
